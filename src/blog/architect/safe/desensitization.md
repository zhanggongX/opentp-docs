...
组成各种 Util 工具类，同时提供以下组件：
![image.png](https://cdn.nlark.com/yuque/0/2024/png/39293052/1710474071252-429e41b6-4798-4188-8806-780bd36bf859.png#averageHue=%23fafafa&clientId=u4f946237-a157-4&from=paste&height=412&id=uafd5161a&originHeight=824&originWidth=771&originalType=binary&ratio=2&rotation=0&showTitle=false&size=165910&status=done&style=none&taskId=u560d2e9f-0cd4-4db8-976e-792372942e5&title=&width=385.5)
...
#### 一行代码实现脱敏
Hutool 提供的脱敏方法如下图所示：
![](https://cdn.nlark.com/yuque/0/2024/png/39293052/1710474099049-bae13f44-33cb-4c71-a0b6-298b1bae5fd9.png#averageHue=%233e444b&clientId=u4f946237-a157-4&from=paste&id=u6203369f&originHeight=331&originWidth=422&originalType=url&ratio=2&rotation=0&showTitle=false&status=done&style=none&taskId=u07570dd2-e8aa-4bc1-82dc-d8d3e5d8421&title=)
...
![image.png](https://cdn.nlark.com/yuque/0/2024/png/39293052/1710483688081-1c73d645-9fd3-446f-a4d9-b6875be4c62e.png#averageHue=%23353230&clientId=u8194e582-e4cb-4&from=paste&height=421&id=ub9f7562a&originHeight=841&originWidth=1853&originalType=binary&ratio=2&rotation=0&showTitle=false&size=130185&status=done&style=none&taskId=u5b7959d7-01ad-49a9-9099-31970a877e8&title=&width=926.5)
可以看到我们成功实现了数据脱敏。
...
- 基于序列化过滤器：需要实现 ValueFilter 接口，重写 process 方法完成自定义脱敏，然后在 JSON 转换时使用自定义的转换策略。具体实现可参考这篇文章： [https://juejin.cn/post/7067916686141161479open in new window](https://juejin.cn/post/7067916686141161479)。
### Mybatis-mate
